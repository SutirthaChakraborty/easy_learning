...
const ListenModule = () => {
  ...
  const scienceNoOrg     = useSelector((state) => state.listenScience.noOrgQuestions);
  ...
  const mathsNoOrg       = useSelector((state) => state.listenMaths.noOrgQuestions);
  ...
  const englishNoOrg     = useSelector((state) => state.listenEnglish.noOrgQuestions);
